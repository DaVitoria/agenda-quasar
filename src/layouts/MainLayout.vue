<template>
  <q-layout view="lHh Lpr lFf">
    ...
    >
      ...
      <q-scroll-area style="height: calc(100% - 162px); margin-top: 162px; border-right: 1px solid #ddd">
        <q-list padding>
          <q-item
          to="/"
          exact
      ...
      <q-img class="absolute-top" id="imagem" src="~assets/imgs/money.jpg" style="height: 150px">
